...
Si può notare come, oltre alla mancanza del layer dei casi d'uso vista la semplicità, i layer siano supportati da un blocco chiamato *System*. In esso vi è il "sistema operativo base" che include lo scheduler e il gestore del risparmio energetico. 
